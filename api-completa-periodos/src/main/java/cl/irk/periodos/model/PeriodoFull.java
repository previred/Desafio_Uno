...
public class PeriodoFull {
	...
	public PeriodoFull fechaCreacion(LocalDate fechaCreacion) {
	...
	public PeriodoFull fechaFin(LocalDate fechaFin) {
	...
	public PeriodoFull fechas(List<LocalDate> fechas) {
		this.fechas = fechas;
		return this;
	}

	public PeriodoFull addFechasItem(LocalDate fechasItem) {
		if (this.fechas == null) {
	...
	public boolean equals(java.lang.Object o) {
		...
		PeriodoFull periodo = (PeriodoFull) o;
