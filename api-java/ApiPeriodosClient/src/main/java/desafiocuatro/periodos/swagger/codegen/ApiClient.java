package desafiocuatro.periodos.swagger.codegen;
...
@Component("desafiocuatro.periodos.swagger.codegen.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://127.0.0.1:8070/periodos";
