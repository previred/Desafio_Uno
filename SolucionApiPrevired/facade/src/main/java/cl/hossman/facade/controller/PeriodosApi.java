...
public interface PeriodosApi {
    ...
    @ApiResponse(code = 415, message = "UNSUPPORTED_MEDIA_TYPE", response = ApiResponseMessageError.class) ,
    @ApiResponse(code = 501, message = "NOT_IMPLEMENTED", response = ApiResponseMessageError.class) ,
    @ApiResponse(code = 502, message = "BAD_GATEWAY", response = ApiResponseMessageError.class) 
    })
