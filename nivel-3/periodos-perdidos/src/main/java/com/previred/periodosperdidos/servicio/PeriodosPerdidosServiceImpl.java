...
public class PeriodosPerdidosServiceImpl implements PeriodosPerdidosService {
	 ...
	 */
	@Override
	public PeriodosPerdidos getPeriodos() throws Exception {
		Periodo periodo = null;
		
		log.info("Invocando a Generador de Datos en la direccion: " + direccionGDD + " ...");
		try {
			periodo = clienteRest.getForObject(direccionGDD, Periodo.class);
